...
publishConfirm: 'Опубликовать «{name}»? Запуски используют замороженный снимок; черновик продолжает редактироваться.',
    ...
    nodes: { Start: 'Старт', LLM: 'LLM', Retrieval: 'Поиск', Switch: 'Ветвление', Answer: 'Ответ', Template: 'Шаблон', VariableAggregator: 'Агрегатор переменных', HTTP: 'HTTP-запрос', DataOps: 'SQL-запрос', WebSearch: 'Веб-поиск', QuestionClassifier: 'Классификатор вопросов', ParameterExtractor: 'Извлечение параметров', Code: 'Код', Iteration: 'Итерация' },
    editor: {
      back: 'Назад',
      save: 'Сохранить',
