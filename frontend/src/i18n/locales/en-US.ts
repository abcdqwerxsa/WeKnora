...
,
  workflow: {
    ...
    nodes: { Start: 'Start', LLM: 'LLM', Retrieval: 'Retrieval', Switch: 'Switch', Answer: 'Answer', Template: 'Template', VariableAggregator: 'Variable Aggregator', HTTP: 'HTTP Request', DataOps: 'DataOps (SQL)', WebSearch: 'Web Search', QuestionClassifier: 'Question Classifier', ParameterExtractor: 'Parameter Extractor', Code: 'Code', Iteration: 'Iteration' },
    editor: {
      back: 'Back',
      save: 'Save',
