...
,
  workflow: {
    ...
    nodes: { Start: 'Старт', LLM: 'LLM', Retrieval: 'Поиск', Switch: 'Ветвление', Answer: 'Ответ', Template: 'Шаблон', VariableAggregator: 'Агрегатор переменных', HTTP: 'HTTP-запрос', DataOps: 'SQL-запрос' },
    editor: {
      back: 'Назад',
      save: 'Сохранить',
