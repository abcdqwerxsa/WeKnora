export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and LuoSA parses and indexes them automatically. Click here to open knowledge bases.'
      },
      chat: {
  ...
  agent: {
    ...
    taskWorkspace: {
      buttonTitle: 'Task workspace',
      title: 'Task workspace',
      tabArtifacts: 'Artifacts',
      tabTerminal: 'Activity',
      empty: 'No artifacts generated in this session yet.',
      emptyTerminal: 'No tool activity yet.',
      collecting: 'Saving generated files…',
      refresh: 'Refresh',
      download: 'Download',
      previewBack: 'Back to list',
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Keep a long-lived container per session on this LuoSA host; scripts and files stay in that container',
      },
      ...
      dockerHostRisk: 'Empty or unix:// uses the Docker daemon on the LuoSA host, which is equivalent to root on that machine. Use this only for a private single-node install. Prefer Cube or E2B when multiple workspaces share a host. Remote tcp:// endpoints require a TLS certificate directory.',
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. If there is no LuoSA standard template, click Create; after changing DNS or the image, click Delete and rebuild.',
      ...
      templateStepHint: 'This step only lists templates already on the cluster; it does not create one automatically. Click Create LuoSA standard template if none exists, or Delete and rebuild after changing DNS or the image. You can continue after a template is ready.',
      ...
      templateUntaggedHint: 'The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; LuoSA will rebuild it.',
      templateFailedReason: 'Build failed: {reason}',
      noTemplates: 'No templates were returned by this cluster.',
      weknoraStandardTemplate: 'LuoSA standard template',
      ...
      replaceStandardTemplateConfirm: 'Rebuild the LuoSA standard template with the current settings, including DNS. The previous spawnable template is not deleted until the replacement is ready.',
  ...
  envVarSettings: {
    ...
    description: 'Personal keys for skills and sandboxes, not LuoSA system or deployment settings.',
  ...
  auth: {
    ...
    registerSubtitle: 'Create your account and start using LuoSA',
    ...
    // Department (workspace to join at registration; server validates tenant.is_joinable)
    department: 'Department',
    departmentPlaceholder: 'Select the department you want to join',
    departmentRequired: 'Please select a department',
    departmentLoadFailed: 'Failed to load department list, please try again later',
    departmentEmpty: 'No departments are accepting new members right now. Please contact your administrator.',
    departmentEmptyHint: 'No departments are open for joining right now. After you submit, we will create a personal workspace for you.',
    // Admin: pending approval queue
    pendingApprovalTitle: 'Pending Approval',
    pendingApprovalSubtitle: 'Review self-registered users before they can sign in',
    pendingApprovalEmpty: 'No users are waiting for approval',
    pendingApprovalApprove: 'Approve',
    pendingApprovalReject: 'Reject',
    pendingApprovalRejectConfirm: 'Reject this registration request? This cannot be undone.',
    pendingApprovalApproved: 'Approved',
    pendingApprovalRejected: 'Rejected',
    pendingApprovalFailed: 'Operation failed, please try again later',
  ...
  createChat: {
    title: 'Hi, I am LuoSA — your knowledge, within reach',
  ...
  agentEditor: {
    ...
    desc: {
      ...
      thinkingHint: 'Disabling keeps reasoning out of the output; the wire field follows the model thinking_control setting.',
  ...
  integrations: {
    ...
    capabilityReadWorkflows: 'Read workflow runs',
    capabilityReadWorkflowsHint: 'Inspect run history and details; cannot execute or modify definitions',
    capabilityRunWorkflows: 'Run workflows',
    capabilityRunWorkflowsHint: 'Execute published workflows (incl. cancel/resume); cannot read or modify definitions',
      ...
      hmacSecretDesc: 'Same secret stored in LuoSA; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted LuoSA: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On LuoSA Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      title: 'LuoSA Skill',
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the LuoSA REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      installCtaHint: 'Install LuoSA Skill · opens in a new tab',
...
,
  ...
  schedules: {
    ...
    nodeDesc: {
      Agent: 'Run one agent turn scoped to knowledge search', MCPTool: 'Call an authorized MCP service tool',
      Iteration: 'Run a body sub-graph once per array item',
      ...
      WebSearch: 'Search via configured providers', QuestionClassifier: 'Classify the question with an LLM and route', ParameterExtractor: 'Extract structured parameters with an LLM'
    },
    title: 'Workflows',
    ...
    edit: 'Edit',
    delete: 'Delete',
    deleteConfirm: 'Delete workflow "{name}"? This cannot be undone.',
    ...
    publishConfirm: 'Publish "{name}"? Runs execute the frozen snapshot; the draft keeps evolving.',
    deleteFailed: 'Failed to delete workflow',
    empty: 'No workflows yet',
    emptyHint: 'Create your first workflow to get started',
    ...
    nodes: { Start: 'Start', LLM: 'LLM', Retrieval: 'Retrieval', Switch: 'Switch', Answer: 'Answer', Template: 'Template', VariableAggregator: 'Variable Aggregator', HTTP: 'HTTP Request', DataOps: 'DataOps (SQL)', WebSearch: 'Web Search', QuestionClassifier: 'Question Classifier', ParameterExtractor: 'Parameter Extractor', Code: 'Code', Iteration: 'Iteration', Agent: 'Agent', MCPTool: 'MCP Tool' },
    editor: {
      back: 'Back',
      save: 'Save',
      autoSavedAt: 'Auto-saved {time}',
      runNode: 'Run this node',
      runNodeTitle: 'Debug node: {name}',
      runNodeHint: 'Fill in each upstream node output JSON as the input for this run; cross-node template references resolve from these values (debug only — not persisted as real upstream results).',
      ...
      treeCountItems: '{n} items',
      refCopyHint: '(click to copy)',
      treeCountFields: '{n} fields',
      schemaEmpty: 'No derivable field structure yet.',
      schemaNoOutputYet: 'Not run yet — the structure above is this node\'s declared output; run it to see live values and samples.',
      pin: 'Pin data',
      unpin: 'Unpin',
      ...
      outputViewJson: 'JSON',
      refCopied: 'Copied {ref} — paste it into a param/prompt',
      runNodeGo: 'Run this node',
      runNodeJsonPlaceholder: 'JSON object, for example "param": "value"',
      runNodeFailed: 'Node run failed',
      nodeInputs: 'Node inputs',
      saveFailed: 'Failed to save workflow',
      importDsl: 'Import DSL',
      exportDsl: 'Export DSL',
      imported: 'DSL imported',
      importFailed: 'Invalid DSL file',
      loadFailed: 'Failed to load workflow',
      notFound: 'Workflow not found',
      properties: 'Properties',
      selectNode: 'Select a node on the canvas to edit its properties',
      prompt: 'Prompt',
      promptHint: 'Supports nodeId＠param references — use the insert button',
      model: 'Model',
      temperature: 'Temperature',
      topK: 'Top K',
      cases: 'Cases',
      caseTarget: 'Target node',
      addCase: 'Add case',
      defaultBranch: 'Default',
      template: 'Template',
      modePointer: 'Pointer (drag to box-select)',
      modeHand: 'Hand (drag to pan)',
      modeComment: 'Comment (click canvas to add a note)',
      ...
      systemPrompt: 'System prompt',
      modelPlaceholder: 'Pick or type a model id',
      maxTokens: 'Max tokens',
      maxTokensHint: '0 keeps the provider default',
      kbSelect: 'Knowledge bases',
      kbSelectHint: 'Select one or more KBs',
      queryTemplate: 'Query template',
      similarityThreshold: 'Similarity threshold',
      vectorThreshold: 'Vector threshold',
      keywordThreshold: 'Keyword threshold',
      thresholdHint: 'Empty = no filtering',
      useRerank: 'Use rerank',
      rerankModel: 'Rerank model',
      rerankModelHint: 'Required when rerank is on',
      addOp: 'Add operation',
      opGroup: 'Operation',
      opName: 'Operation',
      opUpper: 'Upper case',
      ...
      timeout: 'Timeout (s)',
      httpIntranetHint: 'Intranet/private addresses only',
      sql: 'SQL query',
      sqlPlaceholder: 'SELECT ... use $var for upstream variables',
      ...
      issues: {
        ...
        multipleEntries: '{count} entry nodes: {names}. Saving is unaffected, but a run needs exactly one entry — wire the extras to an upstream or remove them',
      ...
      badParent: 'Node {name} loop-body parent {parent} is not an Iteration node',
      bodyEntries: 'Loop body of {name} needs exactly one entry node (found {count})',
      emptyBody: 'Iteration node {name} has no body members',
      },
      formFields: 'Input form fields',
      ...
      variablesDrawer: 'Workflow variables',
      variablesHint: 'Reference via env.name after saving; renaming does not rewrite existing references.',
      variablesName: 'Name',
      variablesValue: 'Value',
      addVariable: 'Add variable',
      searchProvider: 'Search provider',
      searchProviderHint: 'Empty uses the default provider',
      agentKbHint: 'The agent searches only these knowledge bases; empty answers directly',
      platformAgent: 'Reuse platform agent',
      platformAgentHint: 'Pick an existing agent; empty uses the inline config below',
      platformAgentTip: 'When set, the node reuses the whole agent config: prompt, model, knowledge bases, MCP and more',
      mcpService: 'MCP service ID',
      mcpTool: 'Tool name',
      mcpArgs: 'Arguments (JSON)',
      mcpArgsPlaceholder: 'Renders to a JSON object; values may contain node references',
      mcpIntranetHint: 'Only non-interactive auth services (none/api_key/bearer); OAuth services are rejected',
      language: 'Language',
      code: 'Script',
      ...
      classDesc: 'Class description (optional, guides the model)',
      addClass: 'Add class',
      inputText: 'Input text',
      extractParams: 'Extract parameters',
      fieldBool: 'Boolean',
      addExtractParam: 'Add parameter',
      errorHandling: 'Error handling',
      onErrorFail: 'Fail the run',
      onErrorContinue: 'Continue with defaults',
      onErrorRoute: 'Error branch',
      defaultOutputs: 'Default outputs',
      errorRoute: 'Route to on failure',
      errorRouteHint: 'An error branch requires exactly one normal downstream edge',
      retry: 'Retry',
      retryCount: 'Count (0-5)',
      retryDelay: 'Delay (ms)',
      items: 'Items array',
      itemsPlaceholder: 'Template rendering to a JSON array, e.g. an agg＠list reference or [1, 2, 3]',
      itemVar: 'Item variable',
      outputRef: 'Collected output ref',
      outputRefPlaceholder: 'Body terminal output, e.g. a tpl＠text reference',
      outputVar: 'Result variable',
      iterationHint: 'Body members join via the "loop body" picker on each node; the body references the item via iter＠item and iter＠index style refs',
      bodyMembership: 'Loop body',
      bodyMembershipHint: 'Empty = outer graph; picking an Iteration node joins its body',
      },
    run: {
      open: 'Run',
      title: 'Run',
      ...
      cancelledNotice: 'Run cancelled — no answer was produced',
      resume: 'Resume',
      resumeFailed: 'Failed to resume the run',
      resumedNotice: 'Resumed from checkpoint — completed nodes are skipped',
      history: 'Run history',
