...
,
  workflow: {
    ...
    saved: '工作流已保存',
    nodes: { Start: '开始', LLM: 'LLM', Retrieval: '知识检索', Switch: '条件分支', Answer: '回答', Template: '模板变换', VariableAggregator: '变量汇聚', HTTP: 'HTTP 请求', DataOps: '数据查询', WebSearch: '网页搜索', QuestionClassifier: '问题分类', ParameterExtractor: '参数提取', Code: '代码', Iteration: '循环' },
    editor: {
      back: '返回',
      save: '保存',
      saveFailed: '保存工作流失败',
