export default {
  ...
  integrations: {
    ...
    claw: {
      title: 'LuoSA Skill',
      subtitle: 'LuoSA REST API로 문서를 가져오고 하이브리드 검색(벡터+키워드)을 수행합니다. 파일/URL/Markdown 업로드 및 검색에 사용.',
      ...
      installCtaHint: 'LuoSA Skill 설치 · 새 탭에서 열림',
    ...
    chrome: {
      ...
      steps: {
        ...
        port: {
          title: '데스크톱: 고정 포트(권장)',
          desc: 'LuoSA 데스크톱에서는 API 정보에서 고정 포트(예: 37841)를 설정하세요.'
        },
        api: {
          title: 'API 자격 증명',
    ...
    capabilityReadWorkflows: '워크플로 실행 조회',
    capabilityReadWorkflowsHint: '실행 기록과 상세 정보 조회만 가능, 실행·정의 수정은 불가',
    capabilityRunWorkflows: '워크플로 실행',
    capabilityRunWorkflowsHint: '게시된 워크플로 실행(취소/재개 포함), 정의 조회·수정은 불가',
  ...
  agentEditor: {
    ...
    desc: {
      ...
      thinkingOn: '켜기',
      thinkingOff: '끄기',
      thinkingHint: '끄면 사고 내용이 출력에 섞이지 않습니다. 전송 필드는 모델의 thinking_control에 따릅니다.',
  ...
  auth: {
    ...
    // 부서 (등록 시 합류할 워크스페이스; 서버에서 tenant.is_joinable 검증)
    department: '부서',
    departmentPlaceholder: '합류할 부서를 선택하세요',
    departmentRequired: '부서를 선택해주세요',
    departmentLoadFailed: '부서 목록을 불러오지 못했습니다. 잠시 후 다시 시도해주세요',
    departmentEmpty: '현재 가입 가능한 부서가 없습니다. 관리자에게 문의하세요.',
    departmentEmptyHint: '현재 가입 가능한 부서가 없습니다. 제출하시면 개인 작업 공간이 자동으로 생성됩니다.',
    // 관리자: 승인 대기열
    pendingApprovalTitle: '승인 대기',
    pendingApprovalSubtitle: '자체 가입한 사용자가 로그인할 수 있도록 검토합니다',
    pendingApprovalEmpty: '현재 승인 대기 중인 사용자가 없습니다',
    pendingApprovalApprove: '승인',
    pendingApprovalReject: '거부',
    pendingApprovalRejectConfirm: '이 가입 요청을 거부하시겠습니까? 이 작업은 되돌릴 수 없습니다',
    pendingApprovalApproved: '승인됨',
    pendingApprovalRejected: '거부됨',
    pendingApprovalFailed: '작업에 실패했습니다. 잠시 후 다시 시도해주세요',
  ...
  envVarSettings: {
    title: '샌드박스 키',
    description: '스킬과 샌드박스에 쓰는 개인 키이며, LuoSA 시스템이나 배포 설정이 아닙니다.',
    helpAria: '샌드박스 키 설명',
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: '이 LuoSA 호스트의 Docker에서 세션마다 장수명 컨테이너를 유지합니다. 스크립트와 파일이 같은 컨테이너에 남습니다',
      },
      ...
      templateLoadHint: '클러스터 연결을 입력한 뒤 새로고침하세요. LuoSA 표준 템플릿이 없으면 「만들기」를, DNS나 이미지를 바꾼 뒤에는 「삭제 후 재구축」을 누르세요.',
      ...
      templateStepHint: '이 단계에서는 클러스터에 이미 있는 템플릿만 나열하며 자동으로 만들지 않습니다. 표준 템플릿이 없으면 「LuoSA 표준 템플릿 만들기」를, DNS나 이미지를 바꾼 뒤에는 「삭제 후 재구축」을 누르세요. 템플릿이 준비된 뒤에 계속할 수 있습니다.',
      ...
      weknoraStandardTemplate: 'LuoSA 표준 템플릿',
      ...
      replaceStandardTemplateConfirm: '현재 설정(DNS 포함)으로 LuoSA 표준 템플릿을 다시 만듭니다. 새 템플릿이 준비되기 전에는 기존에 쓸 수 있는 템플릿을 삭제하지 않습니다.',
      ...
      cubeDnsServersHelp: '선택 사항입니다. LuoSA 표준 템플릿에 기록되는 nameserver IP입니다. 비워 두면 클러스터 기본값(보통 119.29.29.29)을 사용합니다. 공용 DNS로 UDP/53이 나가지 않으면 Cube 호스트 /etc/resolv.conf에서 도달 가능한 주소를 넣고, 10/8, 172.16/12, 192.168/16은 피하세요. 이미 있는 표준 템플릿은 카드에서 「재구축」을 눌러야 변경이 적용됩니다.',
    ...
    weknoraCloud: {
      ...
      modelsSection: {
        title: '클라우드 모델',
        descReady: 'LuoSA Cloud의 네 가지 표준 모델을 등록하여 대화, 검색, 재정렬, 비전에 사용합니다.',
  ...
  agent: {
    ...
    taskWorkspace: {
      buttonTitle: '작업 워크스페이스',
      title: '작업 워크스페이스',
      tabArtifacts: '산출물',
      tabTerminal: '실행 기록',
      empty: '이 세션에서 아직 생성된 산출물이 없습니다.',
      emptyTerminal: '아직 도구 실행 기록이 없습니다.',
      collecting: '생성된 파일을 저장하는 중…',
      refresh: '새로고침',
      download: '다운로드',
      previewBack: '목록으로',
...
,
  ...
  schedules: {
    ...
    nodeDesc: {
      Agent: '지식 검색으로 제한된 에이전트 턴 실행', MCPTool: '승인된 MCP 서비스 도구 호출',
      Iteration: '배열 항목마다 본문 서브그래프 실행',
      ...
      DataOps: '변수에 SQL 실행',
      HTTP: '내부 HTTP 호출',
      WebSearch: '구성된 프로바이더로 검색', QuestionClassifier: 'LLM으로 질문을 분류하고 라우팅', ParameterExtractor: 'LLM으로 텍스트에서 구조화된 파라미터 추출'
    },
    title: '워크플로',
    subtitle: '캔버스에서 결정론적인 에이전트 워크플로 설계',
    create: '새 워크플로',
    name: '이름',
    namePlaceholder: '워크플로 이름 입력',
    nameRequired: '이름을 입력하세요',
    description: '설명',
    descriptionPlaceholder: '이 워크플로의 용도는 무엇인가요?',
    status: { draft: '초안', published: '게시됨', archived: '보관됨' },
    updatedAt: '업데이트 시간',
    actions: '작업',
    edit: '편집',
    delete: '삭제',
    deleteConfirm: '"{name}" 워크플로를 삭제할까요? 되돌릴 수 없습니다.',
    deleted: '워크플로가 삭제되었습니다',
    publish: '게시',
    unpublish: '게시 취소',
    republish: '게시 갱신',
    archive: '보관',
    published: '워크플로가 게시되었습니다',
    unpublished: '게시가 취소되었습니다',
    archived: '워크플로가 보관되었습니다',
    publishFailed: '게시 작업 실패',
    actionFailed: '작업 실패',
    publishConfirm: '"{name}"을(를) 게시할까요? 게시 후 실행은 스냅샷을 사용하며 초안은 계속 편집할 수 있습니다.',
    deleteFailed: '워크플로 삭제 실패',
    empty: '워크플로가 없습니다',
    emptyHint: '첫 워크플로를 만들어 시작하세요',
    loadFailed: '워크플로 목록을 불러오지 못했습니다',
    retry: '다시 시도',
    createTitle: '워크플로 만들기',
    confirm: '확인',
    cancel: '취소',
    created: '워크플로가 생성되었습니다',
    createFailed: '워크플로 생성 실패',
    saved: '워크플로가 저장되었습니다',
    nodes: { Start: '시작', LLM: 'LLM', Retrieval: '검색', Switch: '분기', Answer: '응답', Template: '템플릿 변환', VariableAggregator: '변수 병합', HTTP: 'HTTP 요청', DataOps: '데이터 쿼리', WebSearch: '웹 검색', QuestionClassifier: '질문 분류', ParameterExtractor: '파라미터 추출', Code: '코드', Iteration: '반복', Agent: '에이전트', MCPTool: 'MCP 도구' },
    editor: {
      back: '뒤로',
      save: '저장',
      autoSavedAt: '자동 저장됨 {time}',
      runNode: '이 노드만 실행',
      runNodeTitle: '노드 디버그: {name}',
      runNodeHint: '각 업스트림 노드의 출력 JSON을 이 실행의 입력으로 입력하세요. 노드 간 템플릿 참조가 이 값에서 해석됩니다(디버그 전용, 실제 결과로 저장되지 않음).',
      runNodeNoUpstream: '업스트림 노드가 없습니다 — 주입된 입력 없이 실행됩니다.',
      runNodeNoOutput: '실행하면 이 노드의 출력이 여기에 표시됩니다.',
      outputViewTree: '트리',
      outputViewSchema: 'Schema',
      treeCountItems: '{n}개 항목',
      refCopyHint: '(클릭하여 복사)',
      treeCountFields: '{n}개 필드',
      schemaEmpty: '아직 파생 가능한 필드 구조가 없습니다.',
      schemaNoOutputYet: '아직 실행 전 — 위 구조는 이 노드의 선언된 출력이며, 실행 후 실제 값이 표시됩니다.',
      pin: '데이터 고정',
      unpin: '고정 해제',
      ...
      outputViewJson: 'JSON',
      refCopied: '{ref} 복사됨 — 파라미터/프롬프트에 붙여넣으세요',
      runNodeGo: '이 노드 실행',
      runNodeJsonPlaceholder: 'JSON 객체, 예: "파라미터": "값"',
      runNodeFailed: '노드 실행 실패',
      nodeInputs: '노드 입력',
      saveFailed: '워크플로 저장 실패',
      importDsl: 'DSL 가져오기',
      exportDsl: 'DSL 내보내기',
      imported: 'DSL을 가져왔습니다',
      importFailed: '잘못된 DSL 파일입니다',
      loadFailed: '워크플로를 불러오지 못했습니다',
      notFound: '워크플로를 찾을 수 없습니다',
      properties: '속성',
      selectNode: '속성을 편집하려면 캔버스에서 노드를 선택하세요',
      prompt: '프롬프트',
      promptHint: 'nodeId＠param 형식 참조 지원 — 삽입 버튼 사용',
      model: '모델',
      temperature: '온도',
      topK: 'Top K',
      cases: '분기 조건',
      ...
      defaultBranch: '기본',
      template: '템플릿',
      modePointer: '포인터(드래그 다중 선택)',
      modeHand: '핸드(드래그 이동)',
      modeComment: '주석(캔버스 클릭해 메모 추가)',
      notePlaceholder: '메모 입력…',
      quickAdd: '다음 노드 추가',
      selfLoopBlocked: '자기 연결은 허용되지 않습니다',
      startHint: '시작 노드는 사용자 입력을 참조 start＠query로 하위에 전달합니다',
      systemPrompt: '시스템 프롬프트',
      modelPlaceholder: '모델 ID 선택 또는 입력',
      maxTokens: '최대 토큰',
      maxTokensHint: '0은 기본값 사용',
      kbSelect: '지식 베이스',
      kbSelectHint: '하나 이상 선택',
      queryTemplate: '질의 템플릿',
      similarityThreshold: '유사도 임계값',
      vectorThreshold: '벡터 임계값',
      keywordThreshold: '키워드 임계값',
      thresholdHint: '비워두면 필터 없음',
      useRerank: '재정렬 사용',
      rerankModel: '재정렬 모델',
      rerankModelHint: '사용 시 필수',
      addOp: '작업 추가',
      opGroup: '작업 유형',
      opName: '작업',
      opUpper: '대문자',
      ...
      bodyTemplate: '본문 템플릿',
      timeout: '타임아웃(초)',
      httpIntranetHint: '내부망/사설 주소만 가능',
      sql: 'SQL 쿼리',
      sqlPlaceholder: 'SELECT ... $변수명으로 상위 변수 참조',
      ...
      issues: {
        ...
        multipleEntries: '입구 노드가 {count}개 있습니다: {names}. 저장에는 영향이 없지만 실행하려면 입구가 하나여야 합니다',
      ...
      badParent: '노드 {name}의 루프 본문 부모 {parent}이(가) 반복 노드가 아닙니다',
      bodyEntries: '{name}의 루프 본문에는 정확히 하나의 진입 노드가 필요합니다 ({count}개 발견)',
      emptyBody: '반복 노드 {name}에 본문 멤버가 없습니다',
      },
      formFields: '입력 양식 필드',
      fieldName: '필드 이름',
      fieldLabel: '라벨(선택)',
      fieldText: '한 줄 텍스트',
      fieldParagraph: '여러 줄 텍스트',
      fieldNumber: '숫자',
      fieldSelect: '선택',
      fieldRequired: '필수',
      fieldDefault: '기본값',
      fieldOptions: '옵션(쉼표 구분)',
      addField: '필드 추가',
      logicAll: '모두 만족',
      logicAny: '하나라도 만족',
      condRef: '참조',
      ...
      variablesBtn: '변수',
      variablesDrawer: '워크플로 변수',
      variablesHint: '저장 후 env.이름 형식으로 참조합니다. 이름 변경 시 기존 참조는 자동 갱신되지 않습니다.',
      variablesName: '이름',
      variablesValue: '값',
      addVariable: '변수 추가',
      searchProvider: '검색 프로바이더',
      searchProviderHint: '비워 두면 기본 프로바이더 사용',
      agentKbHint: '에이전트는 이 지식 기반에서만 검색합니다. 비워 두면 직접 답변',
      platformAgent: '플랫폼 에이전트 재사용',
      platformAgentHint: '기존 에이전트 선택, 비워 두면 아래 인라인 설정 사용',
      platformAgentTip: '선택하면 노드가 해당 에이전트의 프롬프트·모델·지식 기반·MCP 등 전체 설정을 재사용합니다',
      mcpService: 'MCP 서비스 ID',
      mcpTool: '도구 이름',
      mcpArgs: '인수(JSON)',
      mcpArgsPlaceholder: 'JSON 객체로 렌더링됩니다. 값에 노드 참조를 포함할 수 있습니다',
      mcpIntranetHint: '비대화형 인증 서비스만 지원(none/api_key/bearer). OAuth 서비스는 거부됩니다',
      language: '언어',
      code: '스크립트',
      ...
      classes: '분류',
      className: '클래스 이름',
      classDesc: '클래스 설명(선택, 모델 판단에 도움)',
      addClass: '클래스 추가',
      inputText: '입력 텍스트',
      extractParams: '추출 파라미터',
      fieldBool: '불린',
      addExtractParam: '파라미터 추가',
      errorHandling: '오류 처리',
      onErrorFail: '실행 중단',
      onErrorContinue: '기본값으로 계속',
      onErrorRoute: '오류 분기',
      defaultOutputs: '기본 출력',
      errorRoute: '실패 시 라우팅 대상',
      errorRouteHint: '오류 분기는 정상 다운스트림 간선을 정확히 하나 유지해야 합니다',
      retry: '재시도',
      retryCount: '횟수(0-5)',
      retryDelay: '간격(ms)',
      items: '항목 배열',
      itemsPlaceholder: 'JSON 배열로 렌더링되는 템플릿, 예: agg＠list 참조 또는 [1, 2, 3]',
      itemVar: '항목 변수',
      outputRef: '수집 출력 참조',
      outputRefPlaceholder: '본문 터미널 출력, 예: tpl＠text 참조',
      outputVar: '결과 변수',
      iterationHint: '본문 멤버는 각 노드의 "루프 본문" 선택기로 지정합니다. 본문에서는 iter＠item 및 iter＠index 형식 참조를 사용합니다',
      bodyMembership: '루프 본문',
      bodyMembershipHint: '비워 두면 외부 그래프, 선택하면 해당 반복 노드의 본문에 합류',
      },
    run: {
      open: '실행',
      title: '실행',
      ...
      cancel: '실행 취소',
      cancelFailed: '실행 취소 실패',
      cancelledNotice: '실행이 취소되어 응답이 없습니다',
      resume: '재개',
      resumeFailed: '실행 재개에 실패했습니다',
      resumedNotice: '체크포인트에서 재개됩니다 — 완료된 노드는 건너뜁니다',
      history: '실행 기록',
