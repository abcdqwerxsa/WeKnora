...
,
  workflow: {
    ...
    nodes: { Start: 'Start', LLM: 'LLM', Retrieval: 'Retrieval', Switch: 'Switch', Answer: 'Answer', Template: 'Template', VariableAggregator: 'Variable Aggregator', HTTP: 'HTTP Request', DataOps: 'DataOps (SQL)' },
    editor: {
      back: 'Back',
      save: 'Save',
