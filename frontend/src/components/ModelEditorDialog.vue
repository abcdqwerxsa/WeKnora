...
:deep(.t-select.downloading) {
  .t-input {
    ...
    &::before {
      ...
      background: linear-gradient(90deg, rgba(var(--td-brand-rgb), 0.08), rgba(var(--td-brand-rgb), 0.15));
...
.ollama-unavailable-tip {
  ...
  :deep(.tip-link) {
    ...
    &:hover {
      background: rgba(var(--td-brand-rgb), 0.08) !important;
      color: var(--td-brand-color-active) !important;
    }

    &:active {
      background: rgba(var(--td-brand-rgb), 0.12) !important;
    }
