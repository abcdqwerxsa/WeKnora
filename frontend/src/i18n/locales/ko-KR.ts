...
,
  workflow: {
    ...
    saved: '워크플로가 저장되었습니다',
    nodes: { Start: '시작', LLM: 'LLM', Retrieval: '검색', Switch: '분기', Answer: '응답', Template: '템플릿 변환', VariableAggregator: '변수 병합', HTTP: 'HTTP 요청', DataOps: '데이터 쿼리', WebSearch: '웹 검색', QuestionClassifier: '질문 분류', ParameterExtractor: '파라미터 추출', Code: '코드', Iteration: '반복' },
    editor: {
      back: '뒤로',
      save: '저장',
