...
,
  workflow: {
    ...
    nodes: { Start: 'Старт', LLM: 'LLM', Retrieval: 'Поиск', Switch: 'Ветвление', Answer: 'Ответ' },
    editor: {
      back: 'Назад',
      save: 'Сохранить',
      ...
      prompt: 'Промпт',
      promptHint: 'Поддерживает ссылки на выходные параметры других узлов и sys.query',
      model: 'Модель',
      temperature: 'Температура',
      kbIds: 'ID баз знаний (по одному в строке)',
      topK: 'Top K',
      switchValue: 'Значение ветвления',
      switchValueHint: 'Значение для сравнения с условиями',
      cases: 'Условия',
      caseValue: 'Значение',
