...
,
  workflow: {
    ...
    nodes: { Start: 'Start', LLM: 'LLM', Retrieval: 'Retrieval', Switch: 'Switch', Answer: 'Answer' },
    editor: {
      back: 'Back',
      save: 'Save',
      ...
      prompt: 'Prompt',
      promptHint: 'Supports variable references to other node outputs and sys.query',
      model: 'Model',
      temperature: 'Temperature',
      kbIds: 'Knowledge base IDs (one per line)',
      topK: 'Top K',
      switchValue: 'Switch value',
      switchValueHint: 'Value compared against each case',
      cases: 'Cases',
      caseValue: 'Value',
