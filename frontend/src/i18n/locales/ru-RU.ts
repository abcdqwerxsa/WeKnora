...
publishConfirm: 'Опубликовать «{name}»? Запуски используют замороженный снимок; черновик продолжает редактироваться.',
    ...
    editor: {
      ...
      queryPlaceholder: 'Подсказка вопроса',
      prompt: 'Промпт',
      promptHint: 'Поддерживает ссылки nodeId＠param — кнопка вставки',
      model: 'Модель',
      temperature: 'Температура',
      kbIds: 'ID баз знаний (по одному в строке)',
      topK: 'Top K',
      switchValue: 'Значение ветвления',
      switchValueHint: 'Поддерживает ссылки nodeId＠param',
      cases: 'Условия',
      caseValue: 'Значение',
